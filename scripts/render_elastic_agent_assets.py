    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "5. Keep the custom dashboard for agent-specific KPIs like token usage and tool failures; keep trace topology in APM.",
            "",
            "## Ingest mode note",
            "",
            (
    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "4. Pivot back to the custom dashboard only for GenAI-specific KPIs such as token usage and tool failures.",
            "",
